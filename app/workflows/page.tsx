...
export default function Workflows() {
  ...
  return <><Header/><main className="section"><JsonLd data={schema}/><div className="container"><p className="eyebrow">Call workflows</p><h1>VA call center workflows that are easy to run.</h1><p className="lead">A virtual assistant can answer calls, qualify leads, book appointments, and update your CRM. The key is to give the assistant a clear path for each call type.</p>
    ...
    <section className="section"><h2>Safe escalation rules</h2><div className="two"><div className="card"><h3>VA can handle</h3><p>Basic intake, schedule changes, reminders, status notes, simple FAQs, and routing.</p></div><div className="card"><h3>Owner should handle</h3><p>Pricing exceptions, legal or medical advice, refunds, account changes, angry customers, and private data issues.</p></div></div></section>
