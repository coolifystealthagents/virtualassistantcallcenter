...
export default function Home() {
  ...
  return <><Header/><main>
    <JsonLd data={schema} />
    <section className="hero"><div className="container grid"><div><p className="eyebrow">virtual assistant call center</p><h1>Phone support help without the hiring guesswork.</h1><p className="lead">Plan call answering, lead intake, appointment setting, customer follow-up, and QA before you hire a virtual assistant.</p><p>Use this site to choose safe first tasks, build simple scripts, set access rules, and review calls each week. No fake promises. Just a practical plan.</p><div className="button-row"><a className="btn" href="/contact">Build my assistant plan</a><a className="btn secondary" href="/workflows">See call workflows</a></div></div><div className="card"><h3>Best first call tasks</h3><ul className="list"><li>Missed-call follow-up within 5 to 15 minutes</li><li>New lead intake and appointment setting</li><li>Basic customer support triage</li><li>CRM notes after every call</li><li>Reminder calls and reschedules</li></ul><p className="quote">“Start with one script, one queue, and one weekly scorecard.”</p></div></div></section>
