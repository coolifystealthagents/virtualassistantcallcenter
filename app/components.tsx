...
export function Footer() {
  return <footer className="footer legit-footer"><div className="footer-grid"><div className="footer-brand"><a className="footer-logo" href="/" aria-label={`${site.brand || domain} home`}><LogoMark /></a><p>{site.brand || domain} helps small and mid-size teams plan call answering, intake, booking, follow-up, CRM notes, and customer support coverage.</p><p className="footer-note">This is an independent informational website. Submitted requests may be routed to an appropriate staffing team or service partner for follow-up.</p></div><div><h3>Call support</h3><div className="footer-links"><a href="/#coverage">Coverage lanes</a><a href="/workflows">Call workflow</a><a href="/qa-scorecard">QA scorecard</a><a href="/blog">Guides</a></div></div><div><h3>Company</h3><div className="footer-links"><a href="/contact">Contact</a><a href="/privacy">Privacy Policy</a><a href="/terms">Terms & Conditions</a><a href="/cancellation-policy">Cancellation Policy</a></div></div></div><div className="footer-bottom"><span>© {year} {site.brand || domain}. All rights reserved.</span><span>{domain}</span></div></footer>;
}
