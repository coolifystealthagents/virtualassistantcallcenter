---
slug: call-recording-notice-audibility-study
title: Call recording notice audibility study
description: A completed source-corpus review of recording notice delivery, audibility, caller choice, accessibility, and proof limits.
published: 2026-08-17
updated: 2026-08-17
category: Recording evidence research
image: /thumbnails/call-recording-consent-evidence-study.svg
imageAlt: Recording notice evidence review tracing playback, audibility, caller choice, accessibility, and legal interpretation boundaries
related: call-recording-consent-evidence-study, call-recording-consent-review-method
---

## Headline finding

This completed seven-source evidence review found that notice configuration, notice playback, audibility, caller choice, and legal authorization are different propositions. The FCC identifies prior verbal or written notice and a recurring audible tone among notification approaches for interstate calls, while also warning that state rules govern many intrastate situations [1](https://www.fcc.gov/consumers/guides/recording-telephone-conversations). The FTC's telemarketing rule adds a precise control for covered prerecorded messages: an automated opt-out mechanism must be announced and available within 2 seconds of the identification disclosure [2](https://www.ftc.gov/business-guidance/resources/complying-telemarketing-sales-rule). Neither finding lets a call center infer universal consent from a completed audio file.
...
|---|---|---|
| FCC recording guide [1](https://www.fcc.gov/consumers/guides/recording-telephone-conversations) | It describes notification approaches for interstate calls and distinguishes federal practice from varying state rules. | Preserve the governing policy identifier and exact notice version. A playback event alone is not a legal conclusion. |
| FTC telemarketing guide [2](https://www.ftc.gov/business-guidance/resources/complying-telemarketing-sales-rule) | For covered prerecorded messages, the automated opt-out must be announced and made available within 2 seconds after the identification disclosure. | Timing and usability of the choice path are independently testable events. |
| ADA effective communication guidance [3](https://www.ada.gov/resources/effective-communication/) | Covered entities must provide communication that is effective for people with communication disabilities, using appropriate aids or services when required. | Notice review must include relay, speech, hearing, and alternative communication paths. |
| FCC relay service guide [4](https://www.fcc.gov/consumers/guides/telecommunications-relay-service-trs) | The nationwide relay access number is 711, and several forms of telecommunications relay service are described. | A call flow should not clip a notice or block caller action merely because a relay assistant participates. |
| NIST Privacy Framework [5](https://www.nist.gov/privacy-framework) | Five core functions structure privacy risk work: Identify-P, Govern-P, Control-P, Communicate-P, and Protect-P. | Recording evidence needs purpose, access, communication, and protection controls. |
| NIST Cybersecurity Framework [6](https://www.nist.gov/cyberframework) | CSF 2.0 uses 6 functions, adding Govern to Identify, Protect, Detect, Respond, and Recover. | Notice logs and recordings require governance and incident handling, not only storage. |
| FTC data security guidance [7](https://www.ftc.gov/business-guidance/privacy-security/data-security) | The FTC emphasizes collecting only needed information, limiting access, secure storage and transmission, and safe disposal. | An audibility review should use the minimum recording segment and restricted reviewer access. |

## Evidence interpretation

Four of 7 sources directly address a notice, action, or effective-communication question. Three of 7 provide safeguards for the resulting logs or audio. The two numeric findings, 2 seconds in the covered FTC context and the 711 relay access number, have narrow meanings. The 2-second rule is not a general audibility threshold for every inbound call, and 711 does not prove a given flow works with relay services.
...
1. [FCC guide to recording telephone conversations](https://www.fcc.gov/consumers/guides/recording-telephone-conversations)
2. [FTC guide to complying with the Telemarketing Sales Rule](https://www.ftc.gov/business-guidance/resources/complying-telemarketing-sales-rule)
3. [ADA.gov guidance on effective communication](https://www.ada.gov/resources/effective-communication/)
4. [FCC telecommunications relay service guide](https://www.fcc.gov/consumers/guides/telecommunications-relay-service-trs)
...
7. [FTC data security guidance](https://www.ftc.gov/business-guidance/privacy-security/data-security)
