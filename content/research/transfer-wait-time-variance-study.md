---
slug: transfer-wait-time-variance-study
title: Transfer wait-time variance study
description: Evidence-led research on why transfer waits vary by intent, destination, time period, abandonment, and owner availability.
published: 2026-08-13
updated: 2026-08-13
category: Call performance research
image: /thumbnails/call-transfer-latency-measurement.svg
imageAlt: Transfer wait-time variance study with caller evidence, ownership, and bounded interpretation
related: call-transfer-latency-measurement
---

## Headline finding

An average transfer wait hides callers who waited longest or abandoned. Define wait start and end consistently, including connection, abandonment, timeout, or an alternate path. Sample a stable period with destination, intent, time of day, business-hour status, and transfer count. Report median, upper percentile, range, abandonment, and missing-event counts by destination and period. Use distributions rather than one average and compare like-for-like promises. Long waits may reflect demand, routing, ownership, or a destination unable to accept the call. A quicker transfer is not better if it reaches a team without authority or accessibility support. Telephony clocks can differ from queue clocks, and abandonment can reflect network loss or confusing messages. Small samples make upper percentiles unstable, so preserve the measurement version when routing changes. The conclusion should identify inconsistent paths and support investigation of capacity and ownership.
