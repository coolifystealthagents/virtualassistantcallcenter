---
slug: call-menu-intent-routing-accuracy
title: Call menu intent routing accuracy research
description: Evidence-led research on whether callers can map their stated reason to the correct destination and a usable fallback.
published: 2026-08-13
updated: 2026-08-13
category: Call routing research
image: /thumbnails/small-business-call-routing-decision-tree.svg
imageAlt: Call menu intent routing accuracy research with caller evidence, ownership, and bounded interpretation
related: small-business-call-routing-decision-tree
---

## Headline finding

Menu accuracy depends on whether callers can map their reason to a label and then reach the right owner. Build an intent sample from a defined period and compare stated reason, first selection, transfers, final destination, and unresolved status. Keep menu mismatch, wrong selection, and caller uncertainty distinct. Review completed calls, abandoned menus, and fallback calls under the approved policy. Use two reviewers where intent is ambiguous and mark unknown rather than guessing. Report category coverage, first-path agreement, transfer rate, fallback use, and abandonment with sample size and missing-data count. Spoken labels should be tested with accents, speech differences, touch-tone alternatives, and accommodation paths. A high first-path score does not prove resolution if the destination lacks authority or capacity. Menu definitions change when ownership moves, so preserve the version. The conclusion should identify labels that fail callers and transfers that lose responsibility.
...
4. [SBA manage your business](https://www.sba.gov/business-guide/manage-your-business)
5. [BLS customer service representatives](https://www.bls.gov/ooh/office-and-administrative-support/customer-service-representatives.htm)
