...
EXPECTED_TITLE = "Healthcare appointment scheduling with a Philippines virtual assistant"
EXPECTED_SLUG = "healthcare-appointment-scheduling-virtual-assistant-philippines"
EXPECTED_MARKER = "VAC-HEALTH-SCHED-2026-07-27"
...
def main(path):
    ...
    checks = {
        ...
        "visual_identities": visuals == ["telemedicine-similar-care-chart", "healthcare-scheduling-process"],
        ...
        "dated_stats": all(marker in visible for marker in ["15.4%", "86.5%", "76.7%", "73.1%", "50.6%"]),
        "exact_quote": "The revision is more actionable so that health care organizations can improve their cybersecurity posture and comply with the Security Rule." in visible,
        "philippines_only_context": "Filipino virtual assistant" in visible and "in the Philippines" in visible,
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        raise SystemExit("usage: audit_healthcare_article.py BUILT_HTML")
    main(sys.argv[1])
